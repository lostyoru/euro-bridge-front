  ...
  return (
      <div className='side-bar text-[#7C8493] text-lg w-20 sm:w-1/5 bg-[#F8F8FD] pb-52 overflow-hidden '>
        ...
        <div className="profile mt-10 text-center flex flex-col justify-center md:text-left md:flex-row md:justify-around items-center w-4/5 mx-auto ">
          <div className="profile-pic relative z-10">
            <Image src={avatar} alt="avatar" className="w-10 sm:w-14 sm:h-14 rounded-full" />
          </div>
          <div className="profile-details py-1 text-xs md:text-sm">
            <h3 className="profile-name font-bold text-black text-xs hidden sm:block sm:text-sm lg:text-xl">John Doe</h3>
            <p className="profile-email hidden sm:block">jakegyll@email.com</p>
          </div>
        </div>
