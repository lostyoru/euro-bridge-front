    ...
    <footer className='footer'>
      <div className='flex flex-col justify-start items-center lg:flex-row lg:justify-evenly text-white lg:mb-14'>
        ...
        <div className='flex flex-col justify-start items-center mt-14 lg:items-start'>
            ...
            <p className='text-base mb-4 lg:m-auto'>
      ...
      <div className='lg:pl-32 flex flex-col justify-center items-center lg:flex-row lg:justify-between'>
        ...
        <p className='footer-spc-color text-xs font-semibold mb-4 -ml-1'>2024 @ Eurobridge. All rights reserved.</p>
        <div className='social lg:pr-32'>
          <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faFacebook} className='text-white text-lg mr-4' width={30} height={30} /></a>
          <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faInstagram} className='text-white text-lg mr-4' width={30} height={30} /></a>
          <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faLinkedin} className='text-white text-lg mr-4' width={30} height={30} /></a>
          <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faTwitter} className='text-white text-lg mr-4' width={30} height={30} /></a>
        </div>
