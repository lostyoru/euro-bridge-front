  ...
  return (
    ...
    <div className="flex flex-row justify-around ml-20  ">
      ...
      <p className="text-[55px] leading-[4.5rem] mt-10 font-bold font-body w-1/3 " >
        Where <span className="text-[#26A4FF]"> <br/>Trainees </span> And <span className="text-[#26A4FF]">Traineeships </span> <span className="text-primary" >Meet</span>
      </p>
      <p className="text-p mt-4">Launch Your European Career: Connect with Top  <br />Companies & Ignite Your Potential.</p>
      </div>
      <div>
