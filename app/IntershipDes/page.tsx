            ...
            <div className="flex flex-col gap-6">
              <div>
                ...
                <p className="text-p mt-4">
                  ...
                  innovative marketing initiatives in a fast-paced environment.
                </p>
              </div>
              <div>
                <h1 className="capitalize font-bold font-body text-[22px]">
                  ...
                  <ul className="mt-4">
                    <li className="flex flex-row items-center mt-2">
                      ...
                      <p className="text-p px-2">
                        Currently enrolled in a Bachelor&apos;s or Master&apos;s
                        degree program, preferably in Marketing, Business, or a
                        related field
                      </p>
                    </li>
                    <li className="flex flex-row items-center mt-2">
